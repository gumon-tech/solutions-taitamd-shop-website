      ...
      <Reveal>
        <div className="flex items-end justify-between gap-6">
          ...
          <div className="hidden md:flex items-center gap-3">
            <div className="inline-flex items-center gap-2 rounded-2xl border border-ink/12 bg-ink/5 px-4 py-2 text-sm text-mist">
            ...
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-shine inline-flex items-center justify-center gap-2 rounded-2xl bg-ink/5 border border-ink/12 px-5 py-3 text-sm font-semibold hover:bg-ink/8 transition"
            >
          ...
          <div className="lg:col-span-5">
            <div className="glass rounded-[28px] p-5 md:p-6 overflow-hidden">
              <div className="relative rounded-[22px] overflow-hidden border border-ink/10 aspect-[4/3]">
                ...
                />
                <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(246,241,230,0.10),rgba(246,241,230,0.78))]" />
            ...
            <div className="glass rounded-[28px] p-6 md:p-7">
              ...
              <div className="mt-6 md:hidden">
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="btn-shine inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-ink/5 border border-ink/12 px-5 py-3 text-sm font-semibold hover:bg-ink/8 transition"
                >
                  Explore Academy <ArrowUpRight className="h-4 w-4 text-gold" />
                </Link>
              </div>
