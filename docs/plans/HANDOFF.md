...
### ⏸ รอเอกสารราชการ — D-W10 สะกดชื่อผู้ก่อตั้ง

**Kom เคาะวิธีตัดสินแล้ว: ยึดพาสปอร์ต/เอกสารราชการของครูนก ไม่เลือกจากสามฉบับที่เรามี**
(`Phomnongsan` บนเว็บ · `Pomnongsan` ที่เจ้าของเขียน · ธัญรัศม์ **พรหม**หนองแสน) — เพราะใบรับรองผู้เรียนแก้ย้อนหลังไม่ได้
ห้อง Concept ถามให้แล้ว (`D-73` ข้อ 11) จะแจ้งกลับมา
🔒 **ระหว่างนี้ห้ามแก้ คงไว้ที่ `Phomnongsan`** — เดาแล้วแก้เป็นอีกฉบับที่อาจผิดเหมือนกัน ไม่ดีกว่ารอ
เมื่อได้ตัวจริง: แก้ 3 จุดใน [`Story.tsx`](../../components/Story.tsx) commit เดียว ไม่กระทบ JSON-LD · **อย่าลืม `alt` ของรูป**
