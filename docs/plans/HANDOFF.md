...
### 🔴 เร่งที่สุด — W-15 หน้า `/cookies` บรรยาย Academy ผิด **อยู่บน production ตอนนี้**

[`app/cookies/page.tsx:98`](../../app/cookies/page.tsx) เขียนว่า Academy *"sets no cookies of its own"* — **เท็จ**
**วัดเองแล้ว**: `curl -I https://academy.taitam-d.com/en` → `set-cookie: NEXT_LOCALE=en` **ตั้งแต่ยังไม่ล็อกอิน**

🔑 **แยกสองประโยคนี้ให้ขาด:** ❌ *"ไม่เซ็ตคุกกี้เลย"* = เท็จ · ✅ *"ไม่เซ็ตคุกกี้ที่ต้องขอความยินยอม"* = จริง
⚠️ **ผิดมาตั้งแต่ตอนเขียน ไม่ได้ผิดเพราะการสลับลิงก์** — การสลับแค่ทำให้มีคนเดินไปเจอมากขึ้น
🔒 **ห้ามแก้เอง** — เป็นถ้อยคำที่ Legal อนุมัติ · ส่ง diff ที่พร้อมอนุมัติให้ห้อง Legal แล้ว **รอเขาเคาะ**
