...
### ⏸ รอเจ้าของ — D-W12 คำกล่าวอ้าง `VTCT-accredited` · `Certified NLP Master`

ไม่ได้บอกว่าผิด — บอกว่า**เราตรวจเองไม่ได้** และ accreditation มีวันหมดอายุ · ส่งเข้ารอบคำถามเดียวกับ D-W11 แล้ว

### ⏸ รอเจ้าของ — D-W11 คำว่า "Group" / "Beauty Academy"

การสะกด `Taitam-D` แก้ไปแล้ว (W-10) ที่ค้างคือ **ตัวคำ** — `Beauty Academy` ไม่ตรงกับชื่อสถาบันทางการ
`Taitam-D Academy London` (`D-L1`) · ห้องนี้ตอบไม่ได้ว่าเป็นตัวเดียวกันหรือไม่ เป็นเรื่องขอบเขตธุรกิจ
