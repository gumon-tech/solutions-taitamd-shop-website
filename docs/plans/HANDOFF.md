...
🔑 **รอครูนกคนเดียว** — Kom เคาะแทนได้ตาม D-AUTH1 แต่เลือกไม่เคาะ ขอให้ครูนกยืนยันเอง ⇒ **อย่าไปถาม Kom ซ้ำ**
เมื่อเคาะแล้วถ้าเป็น `P`: แก้ 3 จุดใน `Story.tsx` ไฟล์เดียว ไม่กระทบ JSON-LD · ตรวจ `alt` ของรูปด้วยอย่าลืม
