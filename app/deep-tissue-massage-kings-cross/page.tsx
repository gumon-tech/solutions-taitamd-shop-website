...
export default function DeepTissueKingsCrossPage() {
  return (
    <main className="mx-auto max-w-7xl px-5 md:px-8 pb-14 md:pb-12">
      ...
      <section aria-labelledby="dt-faq" className="mt-14 rounded-[28px] border border-ink/10 bg-ink/5 p-7 md:p-9">
        <p className="text-xs tracking-[0.28em] uppercase text-mist">Helpful answers</p>
        <h2 id="dt-faq" className="mt-3 text-2xl md:text-3xl font-semibold">
