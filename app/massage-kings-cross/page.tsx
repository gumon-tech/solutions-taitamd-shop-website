  ...
  return (
    <main className="mx-auto max-w-7xl px-5 md:px-8 pb-14 md:pb-12">
      <header className="pt-8 md:pt-10 pb-10">
        <p className="inline-flex rounded-full bg-[#ebe3d4] px-3 py-1 text-xs tracking-[0.28em] uppercase text-[#6d5223]">Massage</p>
        ...
        <Image
          src="/images/landing/massage.jpg"
          alt="Hands working across a client's shoulders during a back massage"
          width={1200}
          height={805}
